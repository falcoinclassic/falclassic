...
uint256 hashGenesisBlock("0x0000015533751eadb9b26508234333d2d14901d2e99c8872d32fd689942a9b88");
...
// Launch specs
static const int64 nTargetTimespan = 1 * 60; // FalCoin: each block
static const int64 nTargetSpacing = 1 * 60; // FalCoin: 60 seconds
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
      ...
      //vMerkleTree: 3f66108684400d84e2ffb528360d534fa19ecaf47c7c4c2ca1d1352ec4a351ad
        ...
        // Genesis block
        const char* pszTimestamp = "FalClassic";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xe14bb02540f62f194de2df4c07c2d4d818c844420759c6fc90227d9fc1e1f3fb"));
        block.print();
